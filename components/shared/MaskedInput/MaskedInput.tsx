...
export default function MaskedInput({ name, type, label, control, mask, formatChars, maskChar }: MaskedInputProps) {
    return (
        <Controller
            control={control}
            name={name}
