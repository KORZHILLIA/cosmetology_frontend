            ...
            render={({
                ...
                return (
                    <label className={`${wix.className} group relative pb-4 flex flex-col justify-start items-start last-of-type:mb-4`}>
                        ...
                        {isTextType ? <EyeOpened onClick={onEyeClick} className='absolute top-[44px] right-[8px] w-[20px] md:w-[24px] h-[20px] md:h-[24px] fill-brand cursor-pointer' /> : <EyeClosed onClick={onEyeClick} className='absolute top-[44px] right-[8px] w-[20px] md:w-[24px] h-[20px] md:h-[24px] stroke-pale cursor-pointer' />}
