    ...
    return (
        <Section styles="py-10 bg-header" containerStyles="md:flex md:gap-x-8">
            <div className="md:w-full">
                ...
                <Link className="w-[200px] mt-6 flex items-center gap-x-[10px] px-6 py-4 bg-blue dark:bg-sky-800 rounded-lg" href='/contacts'>
                    <span className={`${wix.className} text-white text-lg dark:text-pale`}>Appoint me</span>
                    <Arrow className='w-[24px] md:h-[32px] h-[24px] md:h-[32px] fill-white dark:fill-pale' />
                </Link>
            </div>
            <div className="hidden md:block relative md:w-full h-auto lg:h-[500px] xl:h-[600px] rounded-lg overflow-hidden dark:brightness-50">
