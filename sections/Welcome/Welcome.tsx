        ...
        <section className="py-3">
            <div className="container">
                ...
                <div className="relative w-full rounded-lg overflow-hidden cursor-pointer" onClick={playPause}>
                    ...
                    <Play className={`absolute w-[50px] md:w-[68px] xl:w-[80px] h-[50px] md:h-[68px] xl:h-[80px] top-[50%] left-[50%] -translate-x-[50%] -tranclate-y-[50%] ${isPlaying ? 'scale-0' : 'scale-1'} transition-all`} />
                </div>
            </div>
        </section>
    );
